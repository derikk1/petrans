<template>
  <div class="bg-white shadow-lg p-6 -mt-8 relative z-20">
    <div class="flex justify-between items-center mb-4">
      <h1 class="text-3xl font-bold">PERSADA TRANSPORT INDONESIA</h1>
    ...
    <section class="mb-8">
      ...
      <p class="mt-2" :contenteditable="editMode">The standard chunk of Lorem Ipsum used since the 1500s is reproduced
    ...
    <footer class="flex justify-between items-center">
      ...
      <button @click="$emit('ubah')" class="bg-red-500 text-white px-7 py-1 rounded-md">Ubah</button>
    </footer>
  </div>
</template>
